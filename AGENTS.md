...
config/handsfree-approval.json  optional owner-only instance approval override; otherwise use the personal global policy before the repository default; see docs/handsfree-approvals.md
